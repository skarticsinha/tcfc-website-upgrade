...
<body>
    ...
    <div class="gallery-header-dubai">
        ...
        <div class="gallery-content">
            <div class="container">
            <h3 data-aos="fade-up" data-aos-duration="1000">Dubai, UAE</h3>
            <h1 data-aos="fade-up" data-aos-duration="1300">Famous Dave's</h1>
        </div>
         </div>

    </div>

    <section class="container gallery-list-sec">
    ...
    <?php
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                // Replace these values with the actual columns in your database
