            ...
            if ($result->num_rows > 0) {
                ...
                do {
                    ...
                    if ($row) {
                        ...
                        echo '<h3>' . $projectName . '</h3>'; // Include the project name
                        echo '</div>';
                        echo '</div>';
                        echo '</div>';
                        echo '</a>';
                    ...
                    // If you've reached the end of the results and haven't reached 8 iterations, reset the result pointer to the beginning
                    if (!$row && $iterationCount < 8) {
                        $result->data_seek(0);
                    }
